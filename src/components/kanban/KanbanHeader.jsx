  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={onNewTask} className="px-4 py-2 bg-blue-600 text-white rounded-md text-[13px] font-semibold hover:bg-blue-700 transition-colors flex items-center gap-1.5">
